...
public class ActivitySettings extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            }else if(preference.getKey().equals("switch_music")){
                if (preference.getSummary().equals("true")){
                    MusicManager.pause();
                }else {
                    continueMusic = false;
                    MusicManager.start(context, MusicManager.MUSIC_MENU);
                }
    ...
    private static Preference.OnPreferenceChangeListener bBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        @Override
        public boolean onPreferenceChange(Preference preference, Object value) {
            String stringValue = value.toString();
